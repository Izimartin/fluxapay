/**
 * Loading state for refunds page.
 * Displays a skeleton matching the refunds table layout.
 */

export default function RefundsLoading() {
  return (
    <div className="space-y-6" data-testid="refunds-loading">
      {/* Header skeleton */}
      ...
      <div className="rounded-lg border border-slate-200 overflow-hidden">
        {/* Table header */}
        <div className="bg-slate-50 border-b border-slate-200 grid grid-cols-5 gap-4 p-4">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
        ...
        {[...Array(5)].map((_, rowIdx) => (
          <div
            key={rowIdx}
            className="border-b border-slate-100 grid grid-cols-5 gap-4 p-4"
          >
