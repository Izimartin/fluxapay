...
CREATE INDEX IF NOT EXISTS "Payment_merchantId_createdAt_idx" ON "Payment"("merchantId", "createdAt" DESC);
...
CREATE INDEX IF NOT EXISTS "WebhookLog_merchantId_created_at_idx" ON "WebhookLog"("merchantId", "created_at" DESC);
